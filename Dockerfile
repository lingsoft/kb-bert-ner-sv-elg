...
RUN pip install -r requirements.txt && mkdir local_kb_bert_ner && python load_model.py
...
COPY --chown=elg:elg --from=venv-build /app/local_kb_bert_ner /elg/local_kb_bert_ner
